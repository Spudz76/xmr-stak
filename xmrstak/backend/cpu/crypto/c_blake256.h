...
void hmac_blake256_init(hmac_state *, const uint8_t *, uint32_t);
void hmac_blake224_init(hmac_state *, const uint8_t *, uint32_t);
...
void hmac_blake256_hash(uint8_t *, const uint8_t *, uint32_t, const uint8_t *, uint32_t);
void hmac_blake224_hash(uint8_t *, const uint8_t *, uint32_t, const uint8_t *, uint32_t);
